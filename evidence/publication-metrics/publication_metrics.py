...
metrics['totals']['checked_32_correct']=sum(x['correct'] for r in reports for x in r['summary'] if x['arm'] in ['base-checked','acquired-checked'] and x['step']==32 and x['suite']=='development')
metrics['totals']['checked_32_updates']=3*2*32
